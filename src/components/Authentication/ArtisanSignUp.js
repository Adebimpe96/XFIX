    ...
    <div className="content">
        <div className="left">
            <div className="left-content">
                <h3 className='ml-4 font-bold'> Connect with people who needs your services 24x7<span className='text-blue-700 font-bold'>.</span><span className='text-red-800 font-bold'>.</span><span className='text-yellow-500 font-bold'>.</span></h3>
