    ...
    <>
      <div className="container-lg px-2">
        <div className="flex flex-row">
          <h4 className="red font-semibold py-2 px-3">{props.date}</h4>
        </div>
        <div className="flex flex-rowfont-semibold justify-between border-b-2">
          ...
          <div className="red col text-end my-auto">
            <h6 className="mb-2 mr-3">Cancelled</h6>
          </div>
        </div>
        <div className="flex flex-rowfont-semibold justify-between border-b-2 border-red-400">
          ...
          <div className="col text-end my-auto text-green-700">
            <h6 className="mb-2 mr-3">Successful</h6>
          </div>
        </div>
      </div>
    </>
