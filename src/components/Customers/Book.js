...
const Book = () => {
    ...
    return(
       <div className='container-lg py-4 '>
         <div className='flex flex-col md:flex-row justify-center md:justify-between shadow-lg rounded-md p-4'>
            <div className=' flex md:flex-row flex-col'>
                <div className='px-4 flex justify-center text-center'><img src={avatar} alt="" width={100} /></div>
                <div className='flex flex-col md:text-left justify-center h-full'>
