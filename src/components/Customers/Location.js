...
const Location = () => {
    ...
    return(
        <div className='container-lg mx-auto'> 
            <div className="flex flex-col space-y-2 md:space-x-5 md:flex-row rounded-lg shadow-md">
                <div className='text-start mx-5'>
                    <div><img src={group} alt=""  className='w-1/6'/></div>
                    <div className='px-2  pt-4 '>
                        <div className='inline-flex space-x-3'>
                        <h5 className='font-semibold my-auto text-2xl'>Turn on location services</h5>
                       <div className='gradient rounded-full p-2'><img src={Icon2} alt='' className='w-4'/></div>
                        </div>
                        <p className='text-sm my-2'>
                        Get recommendation of great services! 
                        Turn on your location so we 
                        can show you what's nearby.
                        </p>
                    </div>
                    <div className='text-xs flex my-5'>
